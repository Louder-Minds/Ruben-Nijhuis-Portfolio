...
├── src
│   ├── components # Parts that get used multiple times
...
│   ├── containers # Single use components which use other components
│   ├── helpers
│   │   ├── schemaGenerator.js # Generates JSON-LD schema.org snippets
│   │   ├── mediaTemplates.js # Creates media queries for styled-components
│   │   └── contentfulContentDisplay.js # Formats contentful content [WIP]
